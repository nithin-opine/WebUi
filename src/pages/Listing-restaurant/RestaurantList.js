        ...
        <Row className="mt-4">
          ...
          <Col md="12">
            <Row className="mt-1 restaurantlist">
              {this.state.restaurantinfo.map((restaurant, rid) => (
                <Col md="3" className="restaurantwrapper">
                  <Row>
                    <Col md="12">
                      <div className="rest-img">
                        <img src={restaurant.rimg} alt="" />
                        <div className="delitime">{restaurant.rdtime} mins</div>
                    ...
                    <Col md="12">
                      <span className="rest-name">{restaurant.rname}</span>
                    </Col>
                    <Col md="12">
                      <span className="rest-tags">{restaurant.rtags}</span>
                    </Col>
                    <Col md="12">
                      <Rating rating={restaurant.rrating} /> {restaurant.rcost}{" "}
                      for two
                    </Col>
                    <Col md="12">
                      <hr />
